  ...
  FontOptionModel(this.textStyleModel, List<String> fonts, {this.colors}) {
    ...
    colors = colors ??
        [
          ...
          Colors.yellow,
          Colors.orange,
          Color(int.parse('0xffFF6347')),
          Colors.red,
          Color(int.parse('0xffDC143C')),
          Color(int.parse('0xff4B0082')),
          Color(int.parse('0xffFF1493')),
          Color(int.parse('0xff2F4F4F')),
          Color(int.parse('0xff696969')),
          Color(int.parse('0xffC0C0C0')), 
          Color(int.parse('0xffDCDCDC'))
